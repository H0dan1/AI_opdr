...
"""
#   TODO: [Als real gelijk is aan een geheel getal:
#    Geef terug real als een geheel getal
#    Als real groter is dan 0:
#    Geef terug als geheel getal plus 1
#    Anders geef terug real als geheel getal]
